...
function Battle({ level, playerStats, onWin, onExit }: { level: number; playerStats: any; onWin: (stars: number) => void; onExit: () => void }) {
  ...
  return (
    <div 
      className="w-full h-[100dvh] relative bg-cover bg-center overflow-hidden flex justify-start sm:max-w-md mx-auto shadow-2xl"
    ...
    >
      ...
      <div className="w-[68%] h-full flex flex-col justify-between py-6 px-4 z-10 backdrop-blur-[1px] bg-black/30 relative">
        ...
        <div className="flex-1 flex flex-col items-center justify-center w-full relative">
          ...
          <Board board={board} selected={selected} onSelect={handleSelect} isProcessing={isProcessing || !!levelUpOptions} />
        </div>
        <PlayerInfo 
